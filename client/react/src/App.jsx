...
function App() {
    ...
    const [buttonLocked, setButtonLocked] = useState(<svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 10 16">
    ...
    const fetchStream = () => {
        try {
            fetch('http://localhost:8000/chat', {
                ...
                setHandling(false);
                setButtonLocked(<svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 10 16">
                    <path d="M3.414 1A2 2 0 0 0 0 2.414v11.172A2 2 0 0 0 3.414 15L9 9.414a2 2 0 0 0 0-2.828L3.414 1Z"/>
                </svg>);
            })
        } catch (error) {
    ...
    const handleRequest = async (event) => {
        ...
        setHandling(true);
        setButtonLocked(<svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 16">
                    ...
                    <div className="bg-gray-300 p-4">
                        ...
                        <form className="w-full" method="post" onSubmit={handleRequest}>
                            ...
                            <div className="flex">
                                ...
                                <button className={'rounded px-3 text-sm'} disabled={handling} type="submit">{buttonLocked}</button>
                            </div>
                        </form>
